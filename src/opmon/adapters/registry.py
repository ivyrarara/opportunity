...
from . import bamboohr, greenhouse, hrsmart, hyundai, jobkorea, lever, netflix, njoyn, spa, workday
...
REGISTRY: dict[str, AdapterRunner] = {
    ...
    "netflix": netflix.run,     # Netflix 자체 채용 API(Eightfold). config(NETFLIX_BOARDS) 없으면 skip
    "bamboohr": bamboohr.run,   # 소규모(NUDESTIX 등) — BambooHR 목록 JSON. config 없으면 skip
